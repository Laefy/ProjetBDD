<nav>
	...
	<a title="Accueil" class="home icon" onClick="head_page('home');"></a>
	<a title="Agenda" class="agenda icon" onClick="head_page('agenda');"></a>
	<a title="Consultations" class="consult icon" onClick="head_page('consult');"></a>
